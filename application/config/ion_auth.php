...
|
*/
$config['collections']['users']          = 'user_is';
$config['collections']['groups']         = 'groups_is';
...
$config['tables']['login_attempts']  = 'login_attempts_is';
 ...
 */
$config['site_title']                 = "lineofhealth.ru";       // Site Title, example.com
...
$config['forgot_password_expiration'] = 86400;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
